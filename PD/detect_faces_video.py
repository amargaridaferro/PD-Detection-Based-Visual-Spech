...
def argparser():
    ...
    ap.add_argument("--faceModel", "-m",
        default="Tese/PD/pre_process_scripts/opencv_dlib/opencv_face_detector_uint8.pb",
        help="path to face detection model.")
    ap.add_argument("--faceConfig", "-cfg",
        default="Tese/PD/pre_process_scripts/opencv_dlib/opencv_face_detector.pbtxt",
    ...
    ap.add_argument("--landmarkModel", "-l",
        default="Tese/PD/pre_process_scripts/opencv_dlib/shape_predictor_68_face_landmarks.dat",
        help="path to landmarks predictor model.")
    ap.add_argument("--outputdir", "-o", required=False,
        default="Tese/PD/features/landmarks/",
        help="path to directory where to save landmarks.")
    ap.add_argument("--log", required=False,
        default="Tese/PD/features/face_landmarks.log",
        help="path to directory where to save landmarks.")
    args = ap.parse_args()
    return args
